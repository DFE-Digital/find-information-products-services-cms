...
export interface ApiAdminAdmin extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['super_admin', 'admin', 'editor']> &
...
export interface ApiCategoryTypeCategoryType
  ...
  info: {
    ...
    pluralName: 'category-types';
    singularName: 'category-type';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-type.category-type'
    > &
      Schema.Attribute.Private;
    multi_level: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    ...
    values: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-value.category-value'
    >;
  };
}

export interface ApiCategoryValueCategoryValue
  extends Struct.CollectionTypeSchema {
  collectionName: 'category_values';
  info: {
    displayName: 'Category value';
    pluralName: 'category-values';
    singularName: 'category-value';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    category_type: Schema.Attribute.Relation<
      'manyToOne',
      'api::category-type.category-type'
    >;
...
export interface ApiConfigRoleConfigRole extends Struct.CollectionTypeSchema {
  collectionName: 'config_roles';
  info: {
    displayName: 'Config role';
    pluralName: 'config-roles';
    singularName: 'config-role';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPageDataPageData extends Struct.SingleTypeSchema {
...
export interface ApiPageUpdatePageUpdate extends Struct.SingleTypeSchema {
  collectionName: 'page_updates';
  info: {
    displayName: 'Page: Update';
    pluralName: 'page-updates';
    singularName: 'page-update';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category_values: Schema.Attribute.Relation<
      'manyToMany',
      'api::category-value.category-value'
    >;
    cmdb_last_sync: Schema.Attribute.DateTime;
    cmdb_sys_id: Schema.Attribute.String & Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fips_id: Schema.Attribute.BigInteger & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    entra_id: Schema.Attribute.String;
